      ...
      <div className="max-w-md w-full mx-auto p-8 bg-white dark:bg-gray-900 rounded-lg shadow-md text-black dark:text-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-blue-500 dark:focus:ring-blue-700"
          >
            {loading ? 'Loading...' : 'Login'}
          </button>
        </form>
        <p className="mt-4">Don't have an account?{' '}
          <a href="/register" className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Register</a>
        </p>
      </div>
    </div>
  );
